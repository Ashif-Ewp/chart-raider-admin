export const LEGENDRY_TYPE_EQUIPED = {
...
export const EQUIPMENT_ITEM_SUMMARY = {
  // -------------------- TITANIUM --------------------
...
export const getCaseTypeInfo = (caseType) => {
  return CASE_TYPES.find((type) => type.value === caseType) || {};
};

export const getBonusTypeInfo = (bonusType) => {
  return BONUS_TYPES.find((type) => type.value === bonusType) || {};
};
